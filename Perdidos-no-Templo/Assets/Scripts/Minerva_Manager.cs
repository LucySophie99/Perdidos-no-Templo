...
public class Minerva_Manager : MonoBehaviour
{
 #region Vars

    public GameObject WordSearchGrid;
    public GameObject WordsInWordSearch;
    ...
    public Color SelectColor = new Color(0.2F, 0.3F, 0.4F, 0.5F);
    public Color Correct= new Color(0.2F, 0.3F, 0.4F, 0.5F);
    public Color Wrong= new Color(0.2F, 0.3F, 0.4F, 0.5F);
    ...
    {
        WordsToFind.Add("Jupiter");
        WordsToFind.Add("Minerva");
        WordsToFind.Add("Mercurio");
        WordsToFind.Add("Venus");
        WordsToFind.Add("Marte");
        WordsToFind.Add("Juno");
        WordsToFind.Add("Neptuno");
    ...
    public void MakeUiGrid(char[,] grid)
    {
        ...
        for (int col = 0; col < BoardSize; col++)
        {
            for (int row = 0; row < BoardSize; row++)
            {
                ...
                letter.GetComponent<Minerva_SearchLetter>().row = row;
                letter.GetComponent<Minerva_SearchLetter>().col = col;
    ...
    public void ClearHighlights()
    {
        ...
        foreach (GameObject i in SelectedLettersList)
        {
            i.GetComponentInChildren<Image>().color = i.GetComponent<Minerva_SearchLetter>().DefaultColor;
            i.GetComponent<Minerva_SearchLetter>().isSelected = false;
        }
    ...
    {
        SelectedLetters += WordSearchBoard[letter.GetComponent<Minerva_SearchLetter>().row, letter.GetComponent<Minerva_SearchLetter>().col].ToString();
    }
    ...
    private void Update()
    {
        ...
        if (palavras == 0){
            isPlaying = false;
            WordSearchGrid.SetActive(false);
            WordsInWordSearch.SetActive(false);
    ...
    public void ButtonStart(){
        ...
        WordSearchGrid.SetActive(true);
        WordsInWordSearch.SetActive(true);
        isPlaying = true;
        StartGame();
